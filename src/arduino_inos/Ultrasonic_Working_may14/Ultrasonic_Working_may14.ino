...
const int leftMotorIn1  = 2;  // PWM pin for CW
const int leftMotorIn2  = 3;  // PWM pin for CCW
const int rightMotorIn1 = 4;  // PWM pin for CW
const int rightMotorIn2 = 5;  // PWM pin for CCW
